...
- **Andrew Turk**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **Turk.313**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **4/19/24**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
Because I went for more of a shitpost component, I'm not exactly sure how this would compare to real life. However, even though this was more of a joke, there were still uncommon roadblocks that I ran into while developing this component. Learning how to work around these problems and figuring out a solution requried me to do more research into java and ask for help and suggestions, which did make me feel like I understand the process of software development a little bit more.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

Yes, the project did surface some gaps in my knowledge. One of the most prominent examples of this was that I did not know you couldn't have private or protected methods in interfaces. The first design of my component was planned to have the secondary methods guarantee thier usefulness by making sure the component wouldn't switch during these secondary methods. However, because our discipline requires the secondary methods to only rely on kernel methods, methods to switch the component and to stop it from switching were necessary. However, if these methods are only allowed to be public, the client has access to these methods as well, defeating the purpose of the component. This discovery led me to research other ways to accomplish this task, however, I decided to allow the component to be chaotic in the secondary methods, leaning into the shitpost.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

When doing fun projects like this that allow me to just use what I know to make something stupid, of course I still enjoy that. However, as the year has progressed, I've realized I don't want to follow this industry for the rest of my life. It led me to switch to ECE and focus more on the electrical side. However, this project among other personal goofy projects has made me realize that there is a part of me that loves doing these silly projects, so I will still pursue aspects of software development but more just as my own personal hobbies.
...
I learned a few important skills throughout this process. The first one I can think of is practicing the ability of coming up with my own idea and having the drive to follow through on it. Most of the work we do in school is work that is already laid out, so there's not much origonality involved in it. Another skill I picked up on was the ability to change the course of my project. At the very beginning of this project I was designing a nerual network component. However, as I was working through that I realized that I really didn't have any interst in it and abandoned that project. I completly shifted gears and made this one. Similarly, when I had to change how this QueueStackaroo component worked, it was okay for me to change. Another skill was the ability for me to independantly research things that helped me complete the project. Another skill that helped me complete the project was the ability to ask for help when I needed it. Another perspective was really helpful when going at a problem. Finally, the timing of development was basically all up to me, as the deadlines were more like guidelines, which helped me practice time management
...
Career wise, this project has most likely not affected my trajectory. I am starting to move more away from software design in general, but that was not because of this project. If anything, this project reminded me when I got into software in the first place, as I had a lot of fun doing it. However, I will more likely just start to pursue this type of software development as a personal hobby.
...
Because here at OSU both electrical and computer engineering are combined into one field, I may be able relate some of my skills and get along with computer engineers, who could then introduce me to some more of the electrical side. Also, I have connections through my parents and other recent graduates who I could ask for guidance on what I can do to better prepare myself for my current trajectory.
